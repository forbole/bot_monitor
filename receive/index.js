...
bot.help((ctx) => ctx.reply('This is a bot that will notify you when something happened in the Forbole chain. For more, goto https://github.com/forbole/bot_monitor'))
...
bot.command("/hack", async(ctx, next) => {
    ...
    if (typeof myinput == 'undefined') {
        ctx.reply("Usage: /hack [cosmosvaladdress || hex]")
